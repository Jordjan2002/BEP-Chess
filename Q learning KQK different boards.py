        ...
        while not done and len(played_moves) < 50: # with 50 move rule
            ...
            if obs.turn: # if White to move
                ...
                if done_t1: # if black can end the game
                    ...
                    # print('Max future Q-value:', est_fut_value)
                    ...
                    # print('Max future Q-value:', Q_value_best_move_t2)
                    # print(' ')
...
# code for printing out the results
        ...
        #         print('episode:', episode)
        #         print(env.render())
        #         if checkmate: #env._board.is_checkmate(): # or reward == -1: # last two to make sure it prints it out well if checkmate with 4x4 board
        #             result = 'checkmate'
        #         else:
        #             result = 'draw'
    ...
    with open(f"qtable-KQK-{board_sizes[board_index]}.pickle", "wb") as f:
